...
namespace SmartSweepers2.NN
{
    class GenAlg
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenAlg" /> class and
        ...
        public GenAlg(int populationSize, double mutationRate, double crossoverRate, int chromoLength)
        {
        ...
        /// <summary>Gets the chromos.</summary>
        /// <returns></returns>
